...
<% end %>
~~~
💡 [simple_form](https://github.com/Tarara33/TIL/blob/main/Rails/Gem/simple_form.md)使ってるので　`as: :file`というような書き方してるけど、form_withなら`f.file_field`になる
***
...
## ⭐️ accept:で有効な画像フォーマットをわかりやすくする
~~~
<%= f.input :eye_catch, as: :file, accept: "image/jpeg,image/gif,image/png" %>
~~~
こうすると、有効でない画像は選択するときグレーになって押せない。
  
[![Image from Gyazo](https://i.gyazo.com/6ac2d908b45890dc954f8fa61975079c.png)](https://gyazo.com/6ac2d908b45890dc954f8fa61975079c)
***
...
# バリデーション
[Gemあり](https://github.com/Tarara33/TIL/blob/main/Rails/Gem/active_storage_validations.md)  
[Gemなし](https://github.com/Tarara33/TIL/tree/main/Rails/Model/%E3%83%90%E3%83%AA%E3%83%87%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3/Active%20Storage)
***
